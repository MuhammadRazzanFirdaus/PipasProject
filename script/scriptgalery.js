...
const galleryInfo = {
    ...
    "Tari Ronggeng Gunung": "Tarian ini berasal dari kawasan Puncak, termasuk Cisarua, dan biasanya ditampilkan dalam acara adat sebagai ungkapan rasa syukur atas kekayaan alam. Gerakan dan ekspresinya mencerminkan semangat serta karakter masyarakat setempat.",
    "Tari Tayub": "Merupakan tarian pergaulan yang berfungsi untuk menjalin hubungan sosial dalam masyarakat. Dalam pertunjukannya, penari akan dihampiri oleh tokoh terhormat yang menyematkan selendang sebagai undangan untuk menari bersama. Tarian ini sering memeriahkan acara pernikahan atau perayaan besar lainnya.",
    ...
    "Langgir Badong": "Langgir Badong adalah alat musik tradisional khas Bogor yang dimainkan dengan cara dipukul menggunakan penabuh. Batang penabuh terbuat dari bambu, sementara bagian kepala penabuh dilapisi karet untuk menghasilkan suara yang lebih nyaman didengar.",
    ...
    "Suling Sunda": "Suling Sunda adalah alat musik tiup tradisional khas Jawa Barat yang memiliki ukuran lebih panjang dari suling bambu pada umumnya, yaitu sekitar 60 hingga 70 cm. Panjang ini membuat suara yang dihasilkan lebih lembut, tenang, dan mendayu, sehingga cocok untuk mengiringi musik tradisional Sunda seperti gamelan degung, tembang Cianjuran, dan kacapi suling. Terbuat dari bambu tamiang yang ringan dan kuat, suling ini biasanya memiliki 4 hingga 6 lubang nada di bagian atas serta satu lubang di belakang untuk ibu jari, dan dimainkan sebagai melodi utama atau pengiring dalam pertunjukan seni.",
